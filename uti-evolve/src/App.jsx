...
function SerialMeasurements({title,fieldKey,fields=[],suggestedParams=[],value,onChange,color="#38bdf8",subjective=false,calculator,patient,workflow=false}){
  const T=useTheme();
  ...
  return <div style={{marginTop:9,border:`1px solid ${color}33`,borderRadius:9,background:`${color}08`,overflow:"hidden"}}>
    ...
    {entries.map((e,i)=>{const anterior=i>0?entries[i-1]:null;return <div key={e.id} style={{padding:"8px 9px",borderTop:i?`1px solid ${T.border}`:0}}>
...
const SERIAL_MONITOR_CONFIG={
  ...
  cvPiccoSerial:{title:"PiCCO — CICLO HEMODINÂMICO",color:"#f87171",workflow:true,fields:[{key:"pvc",label:"PVC",reference:"2–6 mmHg"},{key:"ic",label:"IC",reference:"3–5 L/min/m²"},{key:"gedi",label:"GEDI",reference:"680–800 mL/m²"},{key:"elwi",label:"ELWI",reference:"3–7 mL/kg"},{key:"pvpi",label:"PVPI",reference:"1–3"},{key:"svri",label:"SVRI",reference:"1700–2400"},{key:"vvs",label:"VVS",reference:"<10–13%"},{key:"tdci",label:"tdCI",reference:"3–5 L/min/m²"},{key:"gef",label:"GEF",reference:"25–35%"}]},
  cvPerfusaoSerial:{title:"PERFUSÃO — ΔCO₂ / ΔPP · CICLO HEMODINÂMICO",color:"#f87171",workflow:true,fields:[{key:"deltaCO2",label:"ΔCO₂ (mmHg)",reference:"<6"},{key:"deltaPP",label:"ΔPP (%)",reference:"<10%; >13 sugere resposta"},{key:"lactato",label:"Lactato",reference:"<2 mmol/L"},{key:"svcO2",label:"ScvO₂ (%)",reference:"70–80%"}]},
