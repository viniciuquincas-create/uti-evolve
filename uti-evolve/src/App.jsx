    ...
    <div style={{minHeight:"100vh",background:"#080f0a",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Sora','DM Sans',sans-serif"}}>
      ...
      <div style={{width:"100%",maxWidth:380,padding:32}}>
        <div style={{textAlign:"center",marginBottom:36}}>
          <div style={{width:64,height:64,borderRadius:16,background:"linear-gradient(135deg,#15803d,#166534)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:30,margin:"0 auto 16px",border:"2px solid rgba(34,197,94,0.3)"}}>⚕️</div>
          <div style={{fontSize:10,color:"#22c55e",fontFamily:"'DM Mono',monospace",letterSpacing:3,marginBottom:6}}>DMI · EPM · UNIFESP</div>
          <div style={{fontSize:22,fontWeight:700,color:"#e2e8f0",letterSpacing:0.3}}>UTI Evolve</div>
          <div style={{fontSize:11,color:"#475569",fontFamily:"'DM Mono',monospace",letterSpacing:2,marginTop:4}}>ASSISTENTE DE EVOLUÇÃO UTI</div>
        </div>
    ...
    <div style={{minHeight:"100vh",background:"#080f0a",fontFamily:"'Sora','DM Sans',sans-serif",color:"#e2e8f0",display:"flex",flexDirection:"column"}}>
      ...
      <div style={{padding:"0 20px",height:52,display:"flex",alignItems:"center",borderBottom:"1px solid rgba(34,197,94,0.08)",background:"rgba(8,15,10,0.95)",position:"sticky",top:0,zIndex:100,backdropFilter:"blur(8px)"}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          <div style={{width:30,height:30,borderRadius:8,background:"linear-gradient(135deg,#15803d,#166534)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,border:"1px solid rgba(34,197,94,0.2)"}}>⚕️</div>
          <div>
            <div style={{fontSize:14,fontWeight:700,letterSpacing:0.5,color:"#e2e8f0"}}>UTI Evolve</div>
            <div style={{fontSize:9,color:"#22c55e",fontFamily:mono,letterSpacing:2}}>DMI · EPM · UNIFESP</div>
          </div>
        </div>
